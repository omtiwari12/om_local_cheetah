...
<a href="/Ready_For_Review_Request"><span class="m-1" style="font-size: 120%;">Ready for Review</span></a>
 ...
 <div class="accordion" id="accordion1">
  ...
  <div class="accordion-item">
    <h2 class="accordion-header">
      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapsetwo" aria-expanded="true" aria-controls="collapsetwo" style="font-size: 120%; font-weight: bold; font-color: #fffff">
...
<div class="accordion" id="accordion3">
  <div class="accordion-item">
    <h2 class="accordion-header">
      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapsethree" aria-expanded="true" aria-controls="collapsethree" style="font-size: 120%; font-weight: bold; font-color: #fffff">
...
<div class="accordion" id="accordion4">
  <div class="accordion-item">
    <h2 class="accordion-header">
      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapsefour" aria-expanded="true" aria-controls="collapsefour" style="font-size: 120%; font-weight: bold; font-color: #fffff">
