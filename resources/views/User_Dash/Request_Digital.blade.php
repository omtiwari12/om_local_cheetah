            ...
            {{-- <div id="content"> --}}
                ...
                {{-- <div class="container-fluid"> --}}
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-dark ml-4 font-weight-bold ">Digital Marketing Request</h1>
...
@endif
                    ...
                    <div class="" >
                        ...
                        <form   action="{{url('Request_Digital')}}" method="post">
                        ...
                        <div class="card " style="width: 100%;">
                            <div class="card-body" style= border: 5px solid black;>
                                ...
                                <div class="row">
                                  ...
                                  <div class="form-group col-md-4">
                                    <label for="inputState"><h5 class="font-weight-bold">Marketing Types</h5></label>
                                    <select name="Marketing_Type" class="form-control" required >
                                  ...
                                  <div class="form-group col-md-4">
                                    <label for="inputState"><h5 class="font-weight-bold">Creative_Type</h5></label>
                        ...
                        <div class="card  mt-5" style="width: 100%;">
                            <div class="card-body border">
                                ...
                                <div class="form-row">
                                  <div class="form-group col-md-4">
                                    <label for=""><h5 class="font-weight-bold"> Mention completion date!</h5></label>
                                    <input type="date" class="form-control" name="Date" Placeholder=""  required>
                                  </div>
                                  <div class="form-group col-md-4">
                                    <label for="" class="fw-bold"><h5 class="font-weight-bold"> Specific company goals ?</h5></label>
                                    <input type="text" class="form-control" name="Company_Goals"  Placeholder="Company goals"  required>
                                    </select>
                                  </div>
                                  <div class="form-group col-md-4">
                                    <label for=""><h5 class="font-weight-bold"> Company's add platforms</h5></label>
                                    <input type="text" class="form-control" name="Add_Platforms" Placeholder="Advertisement platforms"  required>
                                  </div>
                            ...
                            <div class="card  mt-5" style="width: 100% ;">
                                <div class="card-body">
                                    ...
                                    <div class="form-row">
                                      <div class="form-group col-md-4 auto">
                                        <label for=""><h5 class="font-weight-bold"> Target Audience of company</h5></label>
                                        <input type="text" class="form-control" name="Target_Audience"  Placeholder="Target Audience" required>
                                      </div>
                                      <div class="form-group col-md-4 auto">
                                        <label for="inputState"><h5 class="font-weight-bold">Can you name your Competitors </h5></label>
                                        <input type="text" class="form-control" name="Competitors" Placeholder="Competitors"  required>
                                        </select>
                                      </div>
                                      <div class="form-group col-md-4 auto">
                                        <label for=""><h5 class="font-weight-bold">Target Cutomer's age group?</h5></label>
                                        <select name="Age_Group" class="form-control"  required>
                                          <option selected>Choose...</option>
                                          <option>13-18 years of age</option>
                                          <option>18-23 years of age</option>
                                          <option>23-30 years of age</option>
                                          <option>30-45 years of age</option>
                                          <option>45-60 years of age</option>
                                          <option>60 years of age or above</option>
                                        </select>
                                      </div>
    ...
    <div class="card ">
      <div class="card-body">
        ...
        <!-- <label><strong>Description :</strong></label> -->
                                <textarea class="summernote" name="description" id="summernote2"></textarea>
