            ...
            {{-- <div id="content"> --}}
                ...
                {{-- <div class="container-fluid"> --}}
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-dark ml-4 font-weight-bold ">Web Development Request</h1>
                    ...
                    <ul class="nav nav-tabs ml-4 mb-5" id="myTab" role="tablist">
                      ...
                      <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true"><a href="/Request_web">Request Details</a></button>
                      </li>
                      <li class="nav-item" role="presentation">
...
@endif
                    ...
                    <div class="" >
                        ...
                        <form   action="{{url('Request_web')}}" method="post">
                        ...
                        <div class="card " style="width: 100%;">
                            <div class="card-body" style= border: 5px solid black;>
                                ...
                                <div class="row">
                                  ...
                                  <div class="form-group col-md-4">
                                    <label for="inputState"><h5 class="font-weight-bold">Designs Typess</h5></label>
                                    <select name="Design_Type" class="form-control" Placeholder="Design type"  required>
                        ...
                        <div class="card  mt-5" style="width: 100%;">
                            <div class="card-body border">
                                ...
                                <div class="form-row">
                                  <div class="form-group col-md-4">
                                    <label for=""><h5 class="font-weight-bold">Mention a date before it to be done! </h5></label>
                                    <input type="date" class="form-control" name="Date"   required>
                                  </div>
                                  <div class="form-group col-md-4">
                                    <label for="" class="fw-bold"><h5 class="font-weight-bold">Do you have a Domain for this site?  </h5></label>
                                    <input type="text" class="form-control" name="Domain_Name"  Placeholder="Domain Name"  required>
                                    </select>
                                  </div>
                                  <div class="form-group col-md-4">
                                    <label for=""><h5 class="font-weight-bold">Do you alraedy have a hosting service?</h5></label>
                                    <input type="text" class="form-control" name="Hosting_Services" Placeholder="Hosting Services"  required>
                                  </div>
                            ...
                            <div class="card  mt-5" style="width: 100% ;">
                                <div class="card-body">
                                    ...
                                    <div class="form-row">
                                      <div class="form-group col-md-4 ">
                                        <label for=""><h5 class="font-weight-bold">Do you need logo for your Brand ?</h5></label>
                                        <input type="text" class="form-control" name="Brand_Logo" Placeholder="Brand Logo"  required>
                                      </div>
                                      <div class="form-group col-md-4">
                                        <label for="inputState"><h5 class="font-weight-bold">Do you need content for a  site? </h5></label>
                                        <input type="text" class="form-control" name="Content" Placeholder="Content"  required>
                                        </select>
                                      </div>
                                      <div class="form-group col-md-4 ">
                                        <label for=""><h5 class="font-weight-bold">what is your priority for site?  </h5></label>
...
<div class="row mt-4 mb-4">
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title" style="font-size: 120%; font-weight: bold;">
               ...
               <input type="file" class="dropzone" id="file-upload" enctype="multipart/form-data">
                ...
                <br>
                                 ...
                                 <div class="col-auto mt-4 ">
                                        <center>
                                          <button type="submit" class="btn mt-3 mb-2 d-grid gap-3 col-4 mx-auto" style="background:#000000;color:white;">
                                           Submit
                                          </button>
                                        </center>
                                  </div>
